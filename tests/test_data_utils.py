...
from funcs.data_utils import load_data, randomize_data, split_data
...
class TestLoadData(unittest.TestCase):
    ...
    def test_first_last_elements_X(self):
        ...
        np.testing.assert_array_almost_equal(
            x=Xl[0, -1], y=Xl_first_row_lastc, decimal=6,
            err_msg="Wrong values in Xl (first row, last column).")
        np.testing.assert_array_almost_equal(
            x=Xl[-1, -1], y=Xl_last_row_lastc, decimal=6,
        ...
        np.testing.assert_array_almost_equal(
            x=Xu[0, -1], y=Xu_first_row_lastc, decimal=6,
            err_msg="Wrong values in Xl (first row, last column).")
        np.testing.assert_array_almost_equal(
            x=Xu[-1, -1], y=Xu_last_row_lastc, decimal=6,
            err_msg="Wrong values in Xl (last row, last column).")
